...
//public class SwitchAccountButton extends BookButton {
//    private final Wallet.Type type;
//    private final Wallet wallet;
//    private int personalX, personalY;
//    private int sharedX, sharedY;
//
//    public SwitchAccountButton(Wallet.Type type, BookScreen gui, int buttonId, int x, int y) {
...
//        PenguinNetwork.sendToServer(new SwitchWalletPacket(Wallet.getActive() == Wallet.getWallet(Wallet.Type.PERSONAL)));
//    }
//}
